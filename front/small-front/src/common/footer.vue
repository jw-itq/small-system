<template>
  <div class="footer">
    <div class="container">
      <div class="siteinfo">
        ...
        <ul class="c0">
          ...
          <ul>
            ...
            <li class="c2"><a class="c3" target="_blank" href="https://github.com/Exrick">Exrick</a></li>
        ...
        <ul class="c0">
          <h3 class="c1">关注我吧</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1633138551&site=qq&menu=yes">腾讯 QQ</a></li>
            <!--<li class="c2"><a class="c3" target="_blank" href="http://weibo.com/2255094222/profile">新浪微博</a></li>-->
            <li class="c2"><a class="c3" target="_blank" href="mailto:1633138551@qq.com">官方邮箱</a></li>
          </ul>
        </ul>

        <ul class="c4">
          <li class="tel"><a class="c5" href="http://wpa.qq.com/msgrd?v=3&uin=1633138551&site=qq&menu=yes" target="_blank">1633138551</a></li>
      ...
      <div class="copyright">
        <h4 class="content-c2">Copyright ©2019, SMall-front by shiwanming..Reference from the Exrick </h4>
        <ul class="privacy">
          <li class="content-c1"><a class="content-c0" @click="open1">法律声明</a></li>
          <li class="content-c1"><a class="content-c0" @click="open2">隐私条款</a></li>
          <li class="content-c1"><a class="content-c0" target="_blank" href="https://github.com/shiwanming">开发者中心</a></li>
        </ul>
      </div>
      <div class="cop">
  ...
  export default {
    ...
    methods: {
      ...
      open4 () {
        this.$notify.info({
          title: '支付方式',
          message: '支持支付宝、微信方式付款'
        })
      },
      open5 () {
        this.$notify({
          title: '送货政策',
          message: '本网站所有商品购买后会邮件通知',
          type: 'warning'
        })
      }
    },
