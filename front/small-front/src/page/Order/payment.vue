      ...
      <div slot="content">
        <div class="box-inner order-info">
         ...
         <!-- <p class="payment-detail" style="color:red">请仔细填写捐赠信息，避免系统审核失败无法在捐赠名单中显示您的数据</p>-->
          <p class="payment-detail" style="color:red">请您仔细填写邮箱等信息</p>
        </div>
        <div class="pay-info">
          <span style="color:red">*</span> 昵称：
          <el-input v-model="nickName" placeholder="为了更快给您发货，请输入您支付方式的昵称" @change="checkValid" :maxlength="maxLength" class="input">
