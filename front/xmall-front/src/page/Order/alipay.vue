<template>
  <div class="w" style="padding-bottom: 100px;">
    <y-shelf title="Small收银台 收款方: Tom  (支付留用户名称备注，见效更快哟！)">
      <div slot="content">
        <div class="box-inner order-info">
          <p class="payment-detail">扫一扫付款（元）</p>
          <p class="payment-money">{{orderTotal}}</p>
          <div class="img-box">
            <img id="qr" class="pic" v-bind:src="imgPath" alt="加载失败" width="230px" height="345px"/>
            <div class="explain">
