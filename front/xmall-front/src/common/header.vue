        ...
        <div class="w-box">
          ...
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="SMall商城官网">SMall商城</router-link>
            </h1>
          </div>
          <catogoryNav class="homeNav"></catogoryNav>
          <div class="indexIcon">
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .header-box {
    ...
    background: $head-bgc;
    background-image: -webkit-linear-gradient(#212034, #212034);
    background-image: linear-gradient(#212034, #212034);
    width: 100%;
  }
  header {
    height: 60px;
  ...
  .indexIcon{
    position: absolute;
    left: 180px;
    background: url(/static/images/ic_show.png);
    &:hover{
      background: url(/static/images/ic_show_press.png);
    }
