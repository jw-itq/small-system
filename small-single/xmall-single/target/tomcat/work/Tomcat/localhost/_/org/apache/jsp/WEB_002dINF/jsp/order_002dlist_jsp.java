 ...
 * Generated at: 2019-03-24 14:37:34 UTC
...
public final class order_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<div>\r\n");
      out.write("    <nav class=\"breadcrumb\"><i class=\"Hui-iconfont\">&#xe67f;</i> 首页 <span class=\"c-gray en\">&gt;</span> 订单管理 <span class=\"c-gray en\">&gt;</span> 订单列表 <a class=\"btn btn-success radius r\" style=\"line-height:1.6em;margin-top:3px\" href=\"javascript:location.replace(location.href);\" title=\"刷新\" ><i class=\"Hui-iconfont\">&#xe68f;</i></a></nav>\r\n");
      ...
      out.write("                <a href=\"javascript:;\" onclick=\"orderPrint()\" class=\"btn btn-primary radius\"><i class=\"Hui-iconfont\">&#xe652;</i> 订单打印</a>\r\n");
      out.write("            </span>\r\n");
      out.write("            <span class=\"r\">共有数据：<strong id=\"num\">0</strong> 条</span>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("                        <th width=\"80\">订单号</th>\r\n");
      out.write("                        <th width=\"80\">支付金额(￥)</th>\r\n");
      out.write("                        <th width=\"70\">用户账号</th>\r\n");
      out.write("                        <th width=\"100\">物流号</th>\r\n");
      out.write("                        <th width=\"100\">备注</th>\r\n");
      out.write("                        <th width=\"100\">创建时间</th>\r\n");
      out.write("                        <th width=\"100\">支付时间</th>\r\n");
      out.write("                        <th width=\"100\">关闭时间</th>\r\n");
      out.write("                        <th width=\"100\">完成时间</th>\r\n");
      ...
      out.write("            \"ajax\": {\r\n");
      out.write("                url:\"/order/list\",\r\n");
      out.write("                type: 'GET',\r\n");
      out.write("            },\r\n");
      out.write("            \"columns\": [\r\n");
      out.write("                { \"data\": null,\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return \"<input name=\\\"checkbox\\\" value=\\\"\"+row.orderId+\"\\\" type=\\\"checkbox\\\" value=\\\"\\\">\";\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                { \"data\": \"orderId\"},\r\n");
      out.write("                { \"data\": \"payment\"},\r\n");
      out.write("                { \"data\": \"buyerNick\"},\r\n");
      out.write("                { \"data\": \"shippingCode\"},\r\n");
      out.write("                { \"data\": \"buyerMessage\"},\r\n");
      out.write("                { \"data\": \"createTime\",\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return date(data);\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                { \"data\": \"paymentTime\",\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return date(data);\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                { \"data\": \"closeTime\",\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return date(data);\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                { \"data\": \"endTime\",\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return date(data);\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      ...
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        if(data==0){\r\n");
      out.write("                            return \"<span class=\\\"label label-defant radius td-status\\\">待支付</span>\";\r\n");
      out.write("                        }else if(data==1){\r\n");
      out.write("                            return \"<span class=\\\"label label-warning radius td-status\\\">已支付</span>\";\r\n");
      out.write("                        } else if(data==2){\r\n");
      out.write("                            return \"<span class=\\\"label label-primary radius td-status\\\">待发货</span>\";\r\n");
      out.write("                        }else if(data==3){\r\n");
      out.write("                            return \"<span class=\\\"label label-secondary radius td-status\\\">已发货</span>\";\r\n");
      out.write("                        }else if(data==4){\r\n");
      out.write("                            return \"<span class=\\\"label label-success radius td-status\\\">交易成功</span>\";\r\n");
      out.write("                        }else if(data==5){\r\n");
      out.write("                            return \"<span class=\\\"label label-danger radius td-status\\\">交易关闭</span>\";\r\n");
      out.write("                        }else if(data==6){\r\n");
      out.write("                            return \"<span class=\\\"label label-defant radius td-status\\\">支付失败</span>\";\r\n");
      out.write("                        }else{\r\n");
      ...
      out.write("                    \"data\": null,\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return \"<a title=\\\"发货\\\" href=\\\"javascript:;\\\" onclick=\\\"order_deliver(\"+row.orderId+\")\\\" class=\\\"ml-5\\\" style=\\\"text-decoration:none\\\"><i class=\\\"Hui-iconfont\\\">&#xe603;</i></a>\"+\r\n");
      out.write("                            \"<a title=\\\"备注\\\" href=\\\"javascript:;\\\" onclick=\\\"order_remark('\"+row.buyerMessage+\"',\"+row.orderId+\")\\\" class=\\\"ml-5\\\" style=\\\"text-decoration:none\\\"><i class=\\\"Hui-iconfont\\\">&#xe647;</i></a>\"+\r\n");
      out.write("                            \"<a title=\\\"取消订单\\\" href=\\\"javascript:;\\\" onclick=\\\"order_cancel(\"+row.orderId+\")\\\" class=\\\"ml-5\\\" style=\\\"text-decoration:none\\\"><i class=\\\"Hui-iconfont\\\">&#xe60b;</i></a>\"+\r\n");
      out.write("                            \"<a title=\\\"删除\\\" href=\\\"javascript:;\\\" onclick=\\\"order_del(this,\"+row.orderId+\")\\\" class=\\\"ml-5\\\" style=\\\"text-decoration:none\\\"><i class=\\\"Hui-iconfont\\\">&#xe6e2;</i></a>\";\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            ],\r\n");
      ...
      out.write("            layer.msg('所选订单不属于同一订单!',{icon:5,time:3000});\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        var index = layer.open({\r\n");
      out.write("            type: 2,\r\n");
      out.write("            title: '打印预览',\r\n");
      out.write("            content: 'order-print'\r\n");
      out.write("        });\r\n");
      out.write("        layer.full(index);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function order_deliver(id){\r\n");
      out.write("        orderId=id;\r\n");
      out.write("        layer_show(\"发货\",\"order-deliver\",500,280);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    var oldRemark=\"\";\r\n");
      out.write("    function order_remark(message,id){\r\n");
      out.write("        oldRemark=message;\r\n");
      out.write("        orderId=id;\r\n");
      out.write("        layer_show(\"备注\",\"order-remark\",500,250);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    /*订单-取消*/\r\n");
      out.write("    function order_cancel(id){\r\n");
      out.write("        layer.confirm('确认要取消ID为\\''+id+'\\'的订单吗？',{icon:0},function(index){\r\n");
      out.write("            var index = layer.load(3);\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'GET',\r\n");
      out.write("                url: '/order/cancel/'+id,\r\n");
      ...
      out.write("                    }\r\n");
      out.write("                    refresh();\r\n");
      out.write("                    layer.msg('取消成功!',{icon:1,time:1000});\r\n");
      out.write("                },\r\n");
      out.write("                error:function(XMLHttpRequest){\r\n");
      out.write("                    layer.close(index);\r\n");
      out.write("                    layer.alert('数据处理失败! 错误码:'+XMLHttpRequest.status,{title: '错误信息',icon: 2});\r\n");
      ...
      out.write("\r\n");
      out.write("    /*订单-删除*/\r\n");
      out.write("    function order_del(obj,id){\r\n");
      out.write("        layer.confirm('确认要删除ID为\\''+id+'\\'的订单吗？',{icon:0},function(index){\r\n");
      out.write("            var index = layer.load(3);\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'DELETE',\r\n");
      out.write("                url: '/order/del/'+id,\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success: function(data){\r\n");
      out.write("                    layer.close(index);\r\n");
      out.write("                    if(data.success!=true){\r\n");
