 ...
 * Generated at: 2019-03-24 14:37:48 UTC
...
public final class refresh_002dother_002dredis_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <![endif]-->\r\n");
      out.write("    <title>其它板块缓存管理</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<nav class=\"breadcrumb\"><i class=\"Hui-iconfont\">&#xe67f;</i> 首页 <span class=\"c-gray en\">&gt;</span> 缓存管理 <span class=\"c-gray en\">&gt;</span> 其它板块缓存管理 <a class=\"btn btn-success radius r\" style=\"line-height:1.6em;margin-top:3px\" href=\"javascript:location.replace(location.href);\" title=\"刷新\" ><i class=\"Hui-iconfont\">&#xe68f;</i></a></nav>\r\n");
      out.write("<div style=\"margin-left: 1vw;margin-right: 1vw\" class=\"cl pd-5 bg-1 bk-gray mt-20\">\r\n");
      out.write("    <span class=\"l\">\r\n");
      out.write("        <a class=\"btn btn-primary radius\" onclick=\"refreshRecommendRedis()\" href=\"javascript:;\"><i class=\"Hui-iconfont\">&#xe6bd;</i> 刷新推荐板块缓存</a>\r\n");
      out.write("        <a class=\"btn btn-primary radius\" onclick=\"refreshThankRedis()\" href=\"javascript:;\"><i class=\"Hui-iconfont\">&#xe6bd;</i> 刷新捐赠板块缓存</a>\r\n");
      out.write("    </span>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("                <label class=\"form-label col-xs-6 col-sm-6\" style=\"color: red;margin-bottom: 1vw;\">当修改相应版块关联商品时请记得在此处刷新缓存</label>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"row cl\">\r\n");
      out.write("                <label class=\"form-label col-xs-4 col-sm-1\">推荐板块缓存内容：</label>\r\n");
      out.write("                <div class=\"formControls col-xs-6 col-sm-6\">\r\n");
      out.write("                    <textarea name=\"recommend\" id=\"recommend\" class=\"textarea\"  placeholder=\"当前推荐板块缓存已是最新\" style=\"height: 250px;margin-bottom: 1vw\"></textarea>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"row cl\">\r\n");
      out.write("                <label class=\"form-label col-xs-4 col-sm-1\">捐赠板块缓存内容：</label>\r\n");
      out.write("                <div class=\"formControls col-xs-6 col-sm-6\">\r\n");
      out.write("                    <textarea name=\"thank\" id=\"thank\" class=\"textarea\"  placeholder=\"当前捐赠板块缓存已是最新\" style=\"height: 250px;margin-bottom: 1vw\"></textarea>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </form>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("\r\n");
      out.write("    getRecommendRedisData();\r\n");
      out.write("    function getRecommendRedisData() {\r\n");
      out.write("        var index = layer.load(3);\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type: 'GET',\r\n");
      out.write("            url: '/redis/recommend/list',\r\n");
      out.write("            dataType: 'json',\r\n");
      out.write("            success: function(data) {\r\n");
      out.write("                layer.close(index);\r\n");
      out.write("                if(data.success==true){\r\n");
      out.write("                    $(\"#recommend\").val(data.result);\r\n");
      out.write("                }else{\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    getThankRedisData();\r\n");
      out.write("    function getThankRedisData() {\r\n");
      out.write("        var index = layer.load(3);\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type: 'GET',\r\n");
      out.write("            url: '/redis/thank/list',\r\n");
      out.write("            dataType: 'json',\r\n");
      out.write("            success: function(data) {\r\n");
      out.write("                layer.close(index);\r\n");
      out.write("                if(data.success==true){\r\n");
      out.write("                    $(\"#thank\").val(data.result);\r\n");
      out.write("                }else{\r\n");
      out.write("                    layer.alert('读取缓存数据失败! '+data.message, {title: '错误信息',icon: 2});\r\n");
      out.write("                }\r\n");
      out.write("            },\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function refreshRecommendRedis() {\r\n");
      out.write("        layer.confirm('确认要刷新推荐板块缓存吗？',{icon:0},function(index){\r\n");
      out.write("            var index = layer.load(3);\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'GET',\r\n");
      out.write("                url: '/redis/recommend/update',\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success: function(data) {\r\n");
      out.write("                    layer.close(index);\r\n");
      out.write("                    if(data.success==true){\r\n");
      out.write("                        getRecommendRedisData();\r\n");
      out.write("                        msgSuccess(\"刷新成功!重新打开推荐板块即可重新存入新缓存\");\r\n");
      out.write("                    }else{\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function refreshThankRedis() {\r\n");
      out.write("        layer.confirm('确认要刷新捐赠板块缓存吗？',{icon:0},function(index){\r\n");
      out.write("            var index = layer.load(3);\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'GET',\r\n");
      out.write("                url: '/redis/thank/update',\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success: function(data) {\r\n");
      out.write("                    layer.close(index);\r\n");
      out.write("                    if(data.success==true){\r\n");
      out.write("                        getThankRedisData();\r\n");
      out.write("                        msgSuccess(\"刷新成功!重新打开捐赠板块即可重新存入新缓存\");\r\n");
      out.write("                    }else{\r\n");
      out.write("                        layer.alert('刷新失败! '+data.message, {title: '错误信息',icon: 2});\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
