 ...
 * Generated at: 2019-03-31 06:34:21 UTC
...
public final class admin_002drole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <th width=\"600\">拥有权限</th>\r\n");
      ...
      out.write("                    \"data\": null,\r\n");
      out.write("                    render: function (data, type, row, meta) {\r\n");
      out.write("                        return \"<a style=\\\"text-decoration:none\\\" class=\\\"ml-5\\\" onClick=\\\"admin_role_edit('角色编辑','admin-role-edit',\"+row.id+\")\\\" href=\\\"javascript:;\\\" title=\\\"编辑\\\"><i class=\\\"Hui-iconfont\\\">&#xe6df;</i></a> <a style=\\\"text-decoration:none\\\" class=\\\"ml-5\\\" onClick=\\\"admin_role_del(this,\"+row.id+\")\\\" href=\\\"javascript:;\\\" title=\\\"删除\\\"><i class=\\\"Hui-iconfont\\\">&#xe6e2;</i></a>\";\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            ],\r\n");
      ...
      out.write("                {\"orderable\":false,\"aTargets\":[0,3,5]}// 制定列不参与排序\r\n");
      out.write("            ],\r\n");
      out.write("            language: {\r\n");
      ...
      out.write("    roleCount();\r\n");
      out.write("\r\n");
      out.write("    function roleCount() {\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url:\"/user/roleCount\",\r\n");
      out.write("            type: 'GET',\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    var roleId=-1,name=\"\",description=\"\",permissions=\"\";\r\n");
      out.write("    /*管理员-角色-编辑*/\r\n");
      ...
      out.write("            permissions = table.row(this).data().permissions;\r\n");
      out.write("        });\r\n");
      out.write("        layer_show(title,url,w,h);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      ...
      out.write("        layer.confirm('确认要删除ID为\\''+id+'\\'的角色吗？',{icon:0},function(index){\r\n");
      out.write("            var index = layer.load(3);\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'DELETE',\r\n");
      out.write("                url: '/user/delRole/'+id,\r\n");
      ...
      out.write("            $.ajax({\r\n");
      out.write("                type: 'DELETE',\r\n");
      out.write("                url: '/user/delRole/'+ids,\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success:function(data){\r\n");
      out.write("                    layer.close(index);\r\n");
      out.write("                    if(data.success!=true){\r\n");
