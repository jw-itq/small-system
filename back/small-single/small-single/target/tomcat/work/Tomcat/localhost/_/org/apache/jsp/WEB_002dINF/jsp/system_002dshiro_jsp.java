 ...
 * Generated at: 2019-04-12 09:35:42 UTC
...
public final class system_002dshiro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<div>\r\n");
      out.write("    <nav class=\"breadcrumb\"><i class=\"Hui-iconfont\">&#xe67f;</i> 首页 <span class=\"c-gray en\">&gt;</span> 系统管理 <span class=\"c-gray en\">&gt;</span> 权限配置 <a class=\"btn btn-success radius r\" style=\"line-height:1.6em;margin-top:3px\" href=\"javascript:location.replace(location.href);\" title=\"刷新\" ><i class=\"Hui-iconfont\">&#xe68f;</i></a></nav>\r\n");
      ...
      out.write("                        <th width=\"150\">资源字段名</th>\r\n");
      out.write("                        <th width=\"150\">所需权限</th>\r\n");
      out.write("                        <th width=\"90\">排序</th>\r\n");
      ...
      out.write("                { \"data\": \"id\"},\r\n");
      out.write("                { \"data\": \"name\"},\r\n");
      out.write("                { \"data\": \"perms\"},\r\n");
      out.write("                { \"data\": \"sortOrder\"},\r\n");
      out.write("                {\r\n");
      out.write("                    \"data\": null,\r\n");
      out.write("                    render : function(data,type, row, meta) {\r\n");
      out.write("                        return \"<a title=\\\"编辑\\\" href=\\\"javascript:;\\\" onclick=\\\"shiro_edit('编辑','shiro-edit',\"+row.id+\",'',400)\\\" class=\\\"ml-5\\\" style=\\\"text-decoration:none\\\"><i class=\\\"Hui-iconfont\\\">&#xe6df;</i></a> <a title=\\\"删除\\\" href=\\\"javascript:;\\\" onclick=\\\"shiro_del(this,\"+row.id+\")\\\" class=\\\"ml-5\\\" style=\\\"text-decoration:none\\\"><i class=\\\"Hui-iconfont\\\">&#xe6e2;</i></a>\";\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            ],\r\n");
      out.write("            \"aaSorting\": [[ 4, \"asc\" ]],//默认第几个排序\r\n");
      out.write("            \"bStateSave\": false,//状态保存\r\n");
      out.write("            \"aoColumnDefs\": [\r\n");
      out.write("                {\"orderable\":false,\"aTargets\":[0,5]}// 制定列不参与排序\r\n");
      out.write("            ],\r\n");
      out.write("            language: {\r\n");
      ...
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    shiroCount();\r\n");
      out.write("\r\n");
      out.write("    function shiroCount() {\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url:\"/sys/shiro/count\",\r\n");
      out.write("            type: 'GET',\r\n");
      ...
      out.write("            $.ajax({\r\n");
      out.write("                type: 'DELETE',\r\n");
      out.write("                url: '/sys/shiro/del/'+ids,\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success:function(data){\r\n");
      out.write("                    layer.close(index);\r\n");
      out.write("                    if(data.success!=true){\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    var name=\"\",shiroId=-1,perms=\"\",sortOrder=\"\";\r\n");
      out.write("\r\n");
      out.write("    /*Shiro-编辑*/\r\n");
      out.write("    function shiro_edit(title,url,id,w,h){\r\n");
      out.write("        shiroId=id;\r\n");
      out.write("        var table = $('.table').DataTable();\r\n");
      out.write("        $('.table tbody').on( 'click', 'tr', function () {\r\n");
      out.write("            name = table.row(this).data().name;\r\n");
      out.write("            perms = table.row(this).data().perms;\r\n");
