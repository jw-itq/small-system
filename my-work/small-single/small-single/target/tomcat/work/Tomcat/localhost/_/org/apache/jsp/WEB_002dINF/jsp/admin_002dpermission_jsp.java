 ...
 * Generated at: 2019-03-31 08:24:21 UTC
...
public final class admin_002dpermission_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<div>\r\n");
      out.write("    <nav class=\"breadcrumb\"><i class=\"Hui-iconfont\">&#xe67f;</i> 首页 <span class=\"c-gray en\">&gt;</span> 管理员管理 <span class=\"c-gray en\">&gt;</span> 权限管理 <a class=\"btn btn-success radius r\" style=\"line-height:1.6em;margin-top:3px\" href=\"javascript:location.replace(location.href);\" title=\"刷新\" ><i class=\"Hui-iconfont\">&#xe68f;</i></a></nav>\r\n");
      ...
      out.write("                        <th width=\"200\">权限名称</th>\r\n");
      out.write("                        <th>字段名</th>\r\n");
      ...
      out.write("                    \"data\": null,\r\n");
      out.write("                    render: function (data, type, row, meta) {\r\n");
      out.write("                        return \"<a style=\\\"text-decoration:none\\\" class=\\\"ml-5\\\" onClick=\\\"permission_edit('权限编辑','admin-permission-edit',\"+row.id+\",500,250)\\\" href=\\\"javascript:;\\\" title=\\\"编辑\\\"><i class=\\\"Hui-iconfont\\\">&#xe6df;</i></a> <a style=\\\"text-decoration:none\\\" class=\\\"ml-5\\\" onClick=\\\"permission_del(this,\"+row.id+\")\\\" href=\\\"javascript:;\\\" title=\\\"删除\\\"><i class=\\\"Hui-iconfont\\\">&#xe6e2;</i></a>\";\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            ],\r\n");
      out.write("            \"aaSorting\": [[ 1, \"asc\" ]],//默认第几个排序\r\n");
      ...
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    permissionCount();\r\n");
      out.write("    function permissionCount() {\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url:\"/user/permissionCount\",\r\n");
      out.write("            type: 'GET',\r\n");
      ...
      out.write("\r\n");
      out.write("    /*管理员-权限-添加*/\r\n");
      out.write("    function permission_add(title,url,w,h){\r\n");
      out.write("        layer_show(title,url,w,h);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    var permId=-1,name=\"\",permission=\"\";\r\n");
      out.write("    /*管理员-权限-编辑*/\r\n");
      out.write("    function permission_edit(title,url,id,w,h){\r\n");
      out.write("        permId=id;\r\n");
      out.write("        var table = $('.table').DataTable();\r\n");
      out.write("        $('.table tbody').on( 'click', 'tr', function () {\r\n");
      out.write("            name = table.row(this).data().name;\r\n");
      out.write("            permission = table.row(this).data().permission;\r\n");
      out.write("        });\r\n");
      out.write("        layer_show(title,url,w,h);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    /*管理员-权限-删除*/\r\n");
      out.write("    function permission_del(obj,id){\r\n");
      out.write("        layer.confirm('确认要删除ID为\\''+id+'\\'的数据吗？',{icon:0},function(index){\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                type: 'DELETE',\r\n");
      out.write("                url: '/user/delPermission/'+id,\r\n");
      ...
      out.write("            $.ajax({\r\n");
      out.write("                type: 'DELETE',\r\n");
      out.write("                url: '/user/delPermission/'+ids,\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success:function(data){\r\n");
