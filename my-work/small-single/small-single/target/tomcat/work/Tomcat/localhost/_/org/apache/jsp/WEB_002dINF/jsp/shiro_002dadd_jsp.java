 ...
 * Generated at: 2019-03-31 08:53:34 UTC
...
public final class shiro_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <label class=\"form-label col-xs-4 col-sm-2\"><span class=\"c-red\">*</span>资源字段名：</label>\r\n");
      ...
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      out.write("            <label class=\"form-label col-xs-4 col-sm-2\"><span class=\"c-red\">*</span>所需权限：</label>\r\n");
      out.write("            <div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("                <input type=\"text\" class=\"input-text\" value=\"\" id=\"perms\" name=\"perms\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      out.write("            <label class=\"form-label col-xs-4 col-sm-2\"></label>\r\n");
      out.write("            <div style=\"font-size: 12px;color: grey\" class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("                anon 表示不需要认证以及授权<br>\r\n");
      out.write("                authc 表示需要认证 没有登录是不能进行访问的<br>\r\n");
      out.write("                表示需要该权限才能访问的页面，例如 /user/* = perms[/*]<br>\r\n");
      out.write("                表示需要角色才能访问的页面，例如 /* = roles[管理员]\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      out.write("            <label class=\"form-label col-xs-4 col-sm-2\">排序：</label>\r\n");
      out.write("            <div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("                <input type=\"text\" class=\"input-text\" value=\"\" placeholder=\"请输入0-99999 值越小排序越前\" id=\"sortOrder\" name=\"sortOrder\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      ...
      out.write("                    url: \"/sys/shiro/add\",\r\n");
      out.write("                    type: \"POST\",\r\n");
      out.write("                    success: function (data) {\r\n");
      out.write("                        layer.close(index);\r\n");
      out.write("                        if (data.success == true) {\r\n");
      out.write("                            parent.shiroCount();\r\n");
