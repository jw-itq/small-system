 ...
 * Generated at: 2019-03-29 14:47:15 UTC
...
public final class product_002dedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <input type=\"text\" class=\"input-text\" value=\"\" placeholder=\"\" id=\"title\" name=\"title\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      out.write("            <label class=\"form-label col-xs-4 col-sm-2\"><span class=\"c-red\">*</span>简介描述：</label>\r\n");
      out.write("            <div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("                <input type=\"text\" class=\"input-text\" value=\"\" placeholder=\"\" id=\"sellPoint\" name=\"sellPoint\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      ...
      out.write("            <div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("                <input type=\"text\" name=\"price\" id=\"price\" placeholder=\"请输入正确金额\" value=\"\" class=\"input-text\" style=\"width:50%\">\r\n");
      out.write("                元</div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      ...
      out.write("            <div class=\"formControls col-xs-8 col-sm-9\">\r\n");
      out.write("                <textarea id=\"detail\" name=\"detail\" style=\"width:100%;visibility:hidden;\"></textarea>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"row cl\">\r\n");
      out.write("            <div class=\"col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2\">\r\n");
      out.write("                <button class=\"btn btn-primary radius\" type=\"submit\"><i class=\"Hui-iconfont\">&#xe632;</i> 保存并发布</button>\r\n");
      ...
      out.write("                url: \"/item/update/\"+parent.getId(),\r\n");
      out.write("                type: \"POST\",\r\n");
      ...
      out.write("        $.ajax({\r\n");
      out.write("            type: 'GET',\r\n");
      out.write("            url: '/item/'+parent.getId(),\r\n");
      out.write("            dataType: 'json',\r\n");
      out.write("            success: function(data){\r\n");
      out.write("                layer.close(index);\r\n");
      out.write("                $(\"#title\").val(data.result.title);\r\n");
      out.write("                $(\"#sellPoint\").val(data.result.sellPoint);\r\n");
      out.write("                $(\"#price\").val(data.result.price);\r\n");
      out.write("                $(\"#num\").val(data.result.num);\r\n");
      out.write("                $(\"#cname\").val(data.result.cname);\r\n");
      out.write("                $(\"#cid\").val(data.result.cid);\r\n");
      out.write("                $(\"#limitNum\").val(data.result.limitNum);\r\n");
      out.write("                htmlData=data.result.detail;\r\n");
      out.write("                KindEditor.html('#detail', htmlData);\r\n");
      out.write("            },\r\n");
      out.write("            error:function(XMLHttpRequest) {\r\n");
      out.write("                layer.close(index);\r\n");
      out.write("                layer.alert('数据处理失败! 错误码:'+XMLHttpRequest.status+' 错误信息:'+JSON.parse(XMLHttpRequest.responseText).message,{title: '错误信息',icon: 2});\r\n");
